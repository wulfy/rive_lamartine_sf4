...
final class Version20260418210000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT IGNORE INTO users (id, username, password, email, is_active, roles) VALUES (1, 'wulfy', '\$2y\$12\$Ti22gWmjxf9yPel5.gHnAeFBNQ3oJnlV8JREIOjjXN6kLODtJGKC6', 'wulfy72@yahoo.fr', 1, 'ROLE_ADMIN')");

        $this->addSql(<<<'SQL'
            INSERT IGNORE INTO notes (id, title, img, date, text) VALUES
